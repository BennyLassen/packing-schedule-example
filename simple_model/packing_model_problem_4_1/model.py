"""
Main Model Class for Problem_4_1 Formulation

Simplified packing schedule optimization based on Problem_4_1.pdf.
"""
...
class PackingScheduleModelProblem41:
    """
    Problem_4_1 Packing Schedule Optimization Model.

    Based on Problem_4_1.pdf formulation with:
    - Assignment variables x(i,j,t)
    - Production tracking prod(i,t)
    - Workforce tracking (workersused, workersmax, workersmin)
    - WIP tracking (inventory and shipping)
    - 3-term objective (WIP, workforce, total_not_utilized)
    """

    def __init__(self, data):
        """
        Initialize the Problem_4_1 packing schedule model.
        ...
        """
        self.data = data
        self.model = pyo.ConcreteModel(name="PackingScheduleProblem_4_1")
    ...
    def print_solution_summary(self):
        ...
        print("\n" + "="*80)
        print("SOLUTION SUMMARY (Problem_4_1 Model)")
        print("="*80)
